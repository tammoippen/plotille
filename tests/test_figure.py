...
from plotille._figure_data import Histogram, Plot
...
def test_float_converter(cleandoc):
    ...
    -2.9000000 | ⠀⠀⠀⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
    -----------|-|---------|---------|---------|-> (X)
               | -10.90000 28.700000 68.300000 107.90000"""
    # print(fig.show())
    assert cleandoc(expected) == fig.show()
...
@pytest.mark.parametrize("w_x", [True, False])
@pytest.mark.parametrize("w_y", [True, False])
def test_optional_axis(cleandoc, w_x: bool, w_y: bool):
    fig = Figure()
    fig.with_colors = False
    fig.with_y_axis = w_y
    fig.with_x_axis = w_x
