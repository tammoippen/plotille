...
def test_plot(get_canvas):
    ...
    assert canvas.point.call_args_list == [
        call(0.1, 0.2, color=None, overlay=False, marker='', text=None),
        call(0.2, 0.3, color=None, overlay=False, marker='', text=None),
    ]
    ...
    assert canvas.point.call_count == 2  # two points
    assert canvas.point.call_args_list == [
        call(0.1, 0.2, color=plot.lc, overlay=False, marker='', text=None),
        call(0.2, 0.3, color=plot.lc, overlay=False, marker='', text=None),
    ]
    assert canvas.line.call_count == 1  # two points => one line
    assert canvas.line.call_args_list == [
