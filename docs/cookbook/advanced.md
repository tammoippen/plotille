...
<div class="terminal-window static-example">
   ...
   (Y)     ^                        (Y)     ^                        (Y)     ^                             bucket       | ____________ Total Counts
       235 |                              2 |                              2 |                     [-3.73640, -3.09124) | ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 8 
       211 | ⠀⠀⠀⠀⠀⠀⡀⠀⠀⠀⠀⠀                 1 | ⠀⡏o⡀⠀⠀o⠀⠀⠀⠀⢸                 1 | ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀        [-3.09124, -2.44608) | ⠆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 65
       188 | ⠀⠀⠀⠀⠀⢸⣇⠀⠀⠀⠀⠀                 1 | ⠀⡇⠀⠈⠢⡀⠀⠀⠀⠀⠀⢸                 1 | ⠀⠀⠀⢀⠔⠊⠉⠒⢄⠀⠀⠀        [-2.44608, -1.80092) | ⣿⠆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 269
       164 | ⠀⠀⠀⠀⠀⣼⣿⡀⠀⠀⠀⠀                 0 | ⠀⡇⠀⠀⠀⠈Hi⠀⠀⠀⢸                 0 | ⠀⠀⢠⠃⠀⠀⠀⠀⠀⢣⠀⠀        [-1.80092, -1.15576) | ⣿⣿⣿⣿⠆⠀⠀⠀⠀⠀⠀⠀⠀ 903
       141 | ⠀⠀⠀⠀⢀⣿⣿⡇⠀⠀⠀⠀                 0 | ⠀o⠀o⠀⠀⠀o⠢⡀o⢸                 0 | ⠀⢰⠁⠀⠀⠀⠀⠀⠀⠀⢱⠀        [-1.15576, -0.51060) | ⣿⣿⣿⣿⣿⣿⣿⣿⠇⠀⠀⠀⠀ 1744
       117 | ⠀⠀⠀⠀⢸⣿⣿⡇⠀⠀⠀⠀                 0 | ⣀⣇⣀⣀⣀⣀⣀⣀⣀⣈⣢x                 0 | ⠀⢸⠀⠀⠀⠀⠀⠀⠀⠀⢸⠀        [-0.51060, 0.134555) | ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠀ 2491
        94 | ⠀⠀⠀⠀⣾⣿⣿⣇⠀⠀⠀⠀                 0 | ⠀⡇⠀⠀⠀⠀⠀⠀⠀o⠀⢸                 0 | ⠀⢸⠀⠀⠀⠀⠀⠀⠀⠀⢸⠀        [0.134555, 0.779714) | ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠇⠀ 2366
        70 | ⠀⠀⠀⠀⣿⣿⣿⣿⠀⠀⠀⠀                 0 | ⠀⡇⣀⣀⠀⠀⠀⠀⠀⣀⣀⢸                 0 | ⠀⠘⢄⠀⠀⠀⠀⠀⠀⢀⠜⠀        [0.779714, 1.424874) | ⣿⣿⣿⣿⣿⣿⡗⠀⠀⠀⠀⠀⠀ 1394
        47 | ⠀⠀⠀⢠⣿⣿⣿⣿⡆⠀⠀⠀                -1 | ⠀⡏⠀⠀oo⣀⡠⠊⠀⠀⢹                -1 | ⠀⠀⠈⢆⠀⠀⠀⠀⢀⠎⠀⠀        [1.424874, 2.070033) | ⣿⣿⡗⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 558
        23 | ⠀⠀⠀⣼⣿⣿⣿⣿⣷⠀⠀⠀                -1 | ⠀⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸                -1 | ⠀⠀⠀⠀⠑⠢⠤⠒⠁⠀⠀⠀        [2.070033, 2.715193) | ⡷⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 168
         0 | ⠀⣀⣼⣿⣿⣿⣿⣿⣿⣧⣄⡀                -2 | ⠀⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸                -2 | ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀        [2.715193, 3.360352) | ⠂⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 28
-----------|-|---------|---> (X) -----------|-|---------|---> (X) -----------|-|---------|---> (X) [3.360352, 4.005512) | ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 6
           | -4        3                    | 0         8                    | -2        1         ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾
